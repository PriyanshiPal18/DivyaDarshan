<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true" CodeBehind="Aarti_registration.aspx.cs" Inherits="Divya_Darshan.Aarti_registration" %>
        ...
        <table width="70%">
            <tr>
                ...
                <td class="cell">
                    ...
                    <asp:Calendar ID="Calendar1" runat="server" BorderColor="#a94106"></asp:Calendar>
